...
/**
 * Created by MATHI on 20-08-2016.
 */
public class CircleProgressDrawable extends ProgressBarDrawable {

    private final Paint mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private int mBackgroundColor = R.color.top_color;
    private int mColor =0xFF6600;
//            Color.parseColor("#ffa500");
    private int mBarWidth = 3;
    ...
    public void draw(Canvas canvas) {
        ...
        drawCircle(canvas, R.color.top_color);
        drawArc(canvas, mLevel, R.color.colorPrimary);
    }
